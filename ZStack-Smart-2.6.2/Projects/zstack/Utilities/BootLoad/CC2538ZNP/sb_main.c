/**************************************************************************************************
Filename:       sb_main.c
Revised:        $Date: 2014-07-29 21:30:46 -0700 (Tue, 29 Jul 2014) $
Revision:       $Revision: 39578 $
...
* None.
*
* @return      TRUE if bootloader should download new image, FALSE is existing image should run.
**************************************************************************************************
*/
bool bootloaderCommunicationRequested(void)
{
