/**************************************************************************************************
  ...
  Revised:        $Date: 2011-06-14 13:28:13 -0700 (Tue, 14 Jun 2011) $
  Revision:       $Revision: 26313 $
...
typedef struct
{
  keyDescriptor_t    *keyTable;
  uint8              keyTableEntries;

  deviceDescriptor_t *deviceTable;
  uint8              deviceTableEntries;

  securityLevelDescriptor_t  *securityLevelTable;
